...
def run_donchian_backtest(symbols=["TSLL", "SOXL", "TQQQ"]):
    print("="*60)
    print("🚀 啟動【唐奇安通道(20/10) + 15%移動停利】槓桿 ETF 回測")
    print("="*60)
    ...
    for symbol in symbols:
        ...
        for i in range(len(df)):
            ...
            if position == 0:
                ...
                stop_loss = peak_price * 0.85 # 15% trailing stop
                if p < stop_loss:
                    position = 0
                    trailing_stops += 1
                elif p < l:
